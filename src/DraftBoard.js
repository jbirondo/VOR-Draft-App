...
class DraftBoard extends Component {
    ...
    fetchPlayers(format) {
        ...
        const url = 'https://vorfantasyfootballapi.herokuapp.com/';
        const self = this;
            ...
            if (this.state.isLoading) {
                ...
                if (this.state.fetchError) {
                    ...
                    return ( <div className='row'>
                        <UndraftedAll players={ this.state.filteredPlayers }
                        ...
                        <UndraftedPositions players={ this.state.players }
                        draft={(p)=>this.draft(p)}
                        />

                        <Drafted currentDraft={ this.state.currentDraft }
